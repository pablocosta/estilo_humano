...
model, tokenizer = FastLanguageModel.from_pretrained(
        model_name = "./deepseek/checkpoint-342/", # YOUR MODEL YOU USED FOR TRAINING
        max_seq_length = 300,
...
for ele in tqdm(texts):
    generated_ids = model.generate(ele, top_k = 20, top_p = 0.95, max_new_tokens = 1024)
...
def write_file(data):
    ...
    with open("./preds_deepseek.txt", "w+", encoding="utf-8") as outfile:
        outfile.write("\n".join(data))
