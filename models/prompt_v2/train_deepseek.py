...
from utils import PROMPT_IN_V2, PROMPT_OUT
...
seed=14
checkpoint   = "unsloth/DeepSeek-R1-0528-Qwen3-8B-bnb-4bit"
...
trainer = SFTTrainer(
    ...
    args = SFTConfig(
        ...
        eval_steps=0.1,
        logging_steps=0.1,
        run_name= "deepseek-qwen8b-v2",
        output_dir="./deepseek_qwen8b_finetuned",
        eval_strategy="steps",
...
trainer.train()
trainer.save_model("./deepseek_qwen8b_finetuned")