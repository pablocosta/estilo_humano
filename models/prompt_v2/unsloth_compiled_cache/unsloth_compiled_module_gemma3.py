...
from transformers.models.gemma3.modeling_gemma3 import (Callable, Optional, Tuple, torch, nn, ACT2FN, Cache, FlashAttentionKwargs, ROPE_INIT_FUNCTIONS, dynamic_rope_update, ALL_ATTENTION_FUNCTIONS, Unpack, Gemma3Config, Gemma3TextConfig, logger)
